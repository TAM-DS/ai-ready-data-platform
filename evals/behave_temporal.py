...
REQUEST = (
    "Which state should gross revenue for order 5003 be attributed to "
    "based on the customer's state at the time of the order?"
)
        ...
        response = client.responses.create(
            ...
            input=json.dumps({
                ...
                "governed_capabilities": [
                    ...
                    {
                        "name": "semantic.temporal.has_temporal_mismatch",
                        "attribute_id": "customer_state",
                        "requested_time_context": "historical",
                        "result": temporal_mismatch,
                    },
                ],
            }),
            text={
