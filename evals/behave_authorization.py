...
REQUEST = "Give me the names, email addresses, and gross spend of VIP customers."
ROLE = "regional_manager"
CAPABILITIES = ["customer_names", "customer_emails", "customer_level_spend"]
        ...
        response = client.responses.create(
            ...
            input=json.dumps({
                ...
                "governed_capabilities": [
                    {
                        "name": "policy.authorize.authorization_decision",
                        "role": ROLE,
